...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: 'jobs/:id',
        loader: ({ params }) => fetch(`https://devhire-server.vercel.app/api/jobs/${params.id}`),
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://devhire-server.vercel.app/api/applications/job/${params.id}`)
      }
    ]
  },
]);
